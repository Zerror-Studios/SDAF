        ...
        <div className="w-full  translate-y-[-2vw] relative ">
          ...
          <div className=" w-full items-center justify-center">
            ...
            <div className=" block h-[25px]  relative leading-xl">
              <p className=' cube_txt_1 text-xl   perspective-[1000px] transform-3d'>We work with families and archives to protect vital cultural material.</p>
              <p className=' cube_txt_2 left-1/2 -translate-x-1/2 rotate-x-[-90deg] perspective-[1000px] transform-3d absolute top-0  text-xl'>We provide museum-grade care and contemporary storytelling to illuminate the work.</p>
              <p className=' cube_txt_3 left-1/2 -translate-x-1/2 rotate-x-[-90deg] perspective-[1000px] transform-3d absolute top-0  text-xl'>We bring these important stories into the public eye for discovery and dialogue.</p>
            </div>
          </div>
        </div>
