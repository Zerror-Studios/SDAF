        ...
        <div>
            <div className=" kamot_paren pt-[10vw]  w-full ">
                <div className="w-full h-[30vh] center flex-col">
                    <div className="block">
                        <p className='text-xl text-[#EB8529]'>The Man Behind the Lens</p>
                        <h2 className='text-7xl'>Damodar Kamat (1923–1967)</h2>
                    </div>
                </div>
                <div className=" big_img sticky mb-[10vw] z-[-1] top-1/2 -translate-y-1/2  w-full center flex-col">
                    <img className='w-[25vw]' src="/images/exhibition/DAMODAR_KAMAT.webp" alt="" />
                    <p className='w-[25vw] mt-5 leading-none'>A proud Maharashtrian and a perfectionist, Damodar Kamat founded Kamat Foto Flash in 1945 at
