        ...
        <div>
            <div className=" curat_paren w-full center flex-col">
                <h2 className=' text-3xl lg:text-7xl'>The Curator's Vision</h2>
                    ...
                    <p className='mt-5 w-[80vw] md:w-[50vw] text-sm lg:text-lg lg:w-[25vw] leading-none '>" Curated by Parvez Damania, the selection traces working methods, star-making imagery,
